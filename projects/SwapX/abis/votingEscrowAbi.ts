export const votingEscrowAbi = [
    ...
    },
    {
        ...
        inputs: [
            ...
            { indexed: false, internalType: 'enum VotingEscrowV1_1.DepositType', name: 'deposit_type', type: 'uint8' },
    ...
    },
    {
        ...
        inputs: [
            ...
            { indexed: false, internalType: 'uint256', name: 'tokenId', type: 'uint256' },
            { indexed: false, internalType: 'int128', name: 'bias', type: 'int128' },
            { indexed: false, internalType: 'int128', name: 'slope', type: 'int128' },
            { indexed: false, internalType: 'uint256', name: 'ts', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'blk', type: 'uint256' },
        ],
    ...
    { inputs: [], name: 'MAX_DELEGATES', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
    { inputs: [{ internalType: 'uint256', name: '_tokenId', type: 'uint256' }], name: 'abstain', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    {
        inputs: [
    ...
    { inputs: [], name: 'artProxy', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
    { inputs: [{ internalType: 'uint256', name: '_tokenId', type: 'uint256' }], name: 'attach', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    {
    ...
    { inputs: [], name: 'block_number', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
    ...
    { inputs: [{ internalType: 'uint256', name: '_tokenId', type: 'uint256' }], name: 'detach', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    ...
    { inputs: [{ internalType: 'address', name: '_proxy', type: 'address' }], name: 'setArtProxy', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    { inputs: [{ internalType: 'address', name: '_distributor', type: 'address' }], name: 'setDistributor', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    { inputs: [{ internalType: 'address', name: '_team', type: 'address' }], name: 'setTeam', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    { inputs: [{ internalType: 'address', name: '_voter', type: 'address' }], name: 'setVoter', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    {
        inputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
        name: 'slope_changes',
        outputs: [{ internalType: 'int128', name: '', type: 'int128' }],
    ...
    },
    {
        ...
        outputs: [
            ...
            { internalType: 'uint256[]', name: 'votingPowers', type: 'uint256[]' },
        ],
        stateMutability: 'nonpayable',
        type: 'function',
    },
    ...
    { inputs: [{ internalType: 'uint256', name: '_tokenId', type: 'uint256' }], name: 'voting', outputs: [], stateMutability: 'nonpayable', type: 'function' },
