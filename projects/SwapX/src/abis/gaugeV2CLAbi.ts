export const gaugeV2CLAbi = [
    {
        inputs: [
            ...
            { internalType: 'address', name: '_feeVault2', type: 'address' },
        ],
    ...
    { inputs: [], name: 'DISTRIBUTION', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
    ...
    { inputs: [], name: 'TOKEN_WITHDRAWER', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
    {
    ...
    { inputs: [], name: '_periodFinish', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
    ...
    { inputs: [{ internalType: 'uint256', name: '_amount', type: 'uint256' }], name: 'emergencyWithdrawAmount', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    { inputs: [], name: 'external_bribe', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
    { inputs: [], name: 'feeVault', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
    { inputs: [], name: 'feeVault2', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
    { inputs: [], name: 'fees0', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
    { inputs: [], name: 'fees1', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
    { inputs: [], name: 'gaugeRewarder', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
    { inputs: [], name: 'getReward', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    { inputs: [{ internalType: 'address', name: '_user', type: 'address' }], name: 'getReward', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    ...
    { inputs: [], name: 'rewardForDuration', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
    ...
    { inputs: [], name: 'rewarderPid', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
    {
        inputs: [{ internalType: 'address', name: '', type: 'address' }],
        name: 'rewards',
        outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    ...
    { inputs: [{ internalType: 'address', name: '_distribution', type: 'address' }], name: 'setDistribution', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    {
        inputs: [
            { internalType: 'address', name: '_feeVault', type: 'address' },
            { internalType: 'address', name: '_feeVault2', type: 'address' },
    ...
    { inputs: [{ internalType: 'address', name: '_gaugeRewarder', type: 'address' }], name: 'setGaugeRewarder', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    { inputs: [{ internalType: 'address', name: '_int', type: 'address' }], name: 'setInternalBribe', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    { inputs: [{ internalType: 'uint256', name: '_pid', type: 'uint256' }], name: 'setRewarderPid', outputs: [], stateMutability: 'nonpayable', type: 'function' },
