export const cowswapSettlementAbi = [
    {
        inputs: [
    ...
    { inputs: [], name: 'authenticator', outputs: [{ internalType: 'contract GPv2Authentication', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
    ...
    { inputs: [{ internalType: 'bytes[]', name: 'orderUids', type: 'bytes[]' }], name: 'freeFilledAmountStorage', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    { inputs: [{ internalType: 'bytes[]', name: 'orderUids', type: 'bytes[]' }], name: 'freePreSignatureStorage', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    {
        inputs: [
    ...
    { inputs: [], name: 'vaultRelayer', outputs: [{ internalType: 'contract GPv2VaultRelayer', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
