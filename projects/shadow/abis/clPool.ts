export const CL_POOL_ABI = [
    ...
    { type: 'function', name: '_advancePeriod', inputs: [], outputs: [], stateMutability: 'nonpayable' },
    {
        type: 'function',
        name: 'burn',
        inputs: [
    ...
    },
    {
        ...
        outputs: [
            { name: 'previousPeriod', type: 'uint32', internalType: 'uint32' },
            { name: 'startTick', type: 'int24', internalType: 'int24' },
            { name: 'lastTick', type: 'int24', internalType: 'int24' },
            { name: 'endSecondsPerLiquidityPeriodX128', type: 'uint160', internalType: 'uint160' },
        ],
        stateMutability: 'view',
    },
    {
        ...
        outputs: [{ name: 'periodSecondsInsideX96', type: 'uint256', internalType: 'uint256' }],
        stateMutability: 'view',
    },
    {
        type: 'function',
    ...
    },
    {
        ...
        outputs: [{ name: 'returnData', type: 'bytes32[]', internalType: 'bytes32[]' }],
        stateMutability: 'view',
    },
    {
        type: 'function',
    ...
    { type: 'function', name: 'setFeeProtocol', inputs: [], outputs: [], stateMutability: 'nonpayable' },
    {
        type: 'function',
        name: 'slot0',
        inputs: [],
    ...
    },
    {
        type: 'function',
        name: 'tickBitmap',
        inputs: [{ name: 'tick', type: 'int16', internalType: 'int16' }],
        outputs: [{ name: '', type: 'uint256', internalType: 'uint256' }],
        stateMutability: 'view',
    },
    {
    ...
    { type: 'error', name: 'OLD', inputs: [] },
    { type: 'error', name: 'R', inputs: [] },
    { type: 'error', name: 'SPL', inputs: [] },
    { type: 'error', name: 'T', inputs: [] },
    { type: 'error', name: 'TF', inputs: [] },
