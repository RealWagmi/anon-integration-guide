...
import { getMarketExpiry, getMarketType, getMarketsWithCurrency } from '../helpers/markets';
 ...
 */
export async function getCurrencyMarkets({ currency }: Props, { getCcxtExchange }: FunctionOptions): Promise<FunctionReturn> {
	try {
