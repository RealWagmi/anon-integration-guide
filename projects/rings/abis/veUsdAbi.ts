export const veUsdAbi = [
    ...
    { inputs: [], name: 'AlreadyAttached', type: 'error' },
    { inputs: [], name: 'InvalidNonce', type: 'error' },
    { inputs: [], name: 'InvalidSignature', type: 'error' },
    { inputs: [], name: 'LockExpired', type: 'error' },
    { inputs: [], name: 'LockInFuture', type: 'error' },
    { inputs: [], name: 'LockTooLong', type: 'error' },
    { inputs: [], name: 'NoLock', type: 'error' },
    { inputs: [], name: 'NotApprovedOrOwner', type: 'error' },
    { inputs: [], name: 'NotToken', type: 'error' },
    { inputs: [], name: 'SignatureExpired', type: 'error' },
    { inputs: [], name: 'TooManyDelegates', type: 'error' },
