...
var indexToken = CONTRACT_ADDRESSES[NETWORKS.SONIC].NATIVE_TOKEN; // S token
var collateralToken = CONTRACT_ADDRESSES[NETWORKS.SONIC].NATIVE_TOKEN; // S token as collateral
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var provider, signer, result, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    provider = new ethers.providers.JsonRpcProvider(RPC_URLS[NETWORKS.SONIC]);
                    signer = new ethers.Wallet(process.env.PRIVATE_KEY, provider);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, openLongPositionWithValue({
                            signer: signer,
