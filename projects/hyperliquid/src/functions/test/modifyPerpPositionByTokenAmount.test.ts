...
import { modifyPerpPositionByTokenAmount } from '../modifyPerpPositionByTokenAmount';
...
describe('modifyPerpPositionByTokenAmount', () => {
    beforeEach(() => {
        vi.clearAllMocks();
    });
    ...
    it('should modify position successfully', async () => {
        ...
        const result = await modifyPerpPositionByTokenAmount(defaultProps, functionOptions as any);
    ...
    it('should resolve vault name to address', async () => {
        ...
        const result = await modifyPerpPositionByTokenAmount({ ...defaultProps, vault: 'vault-name' }, functionOptions as any);
