 ...
 */
export async function toggleAutoCloseOnWithdrawal({ account, vault, value }: Props, { evm: { signTypedDatas } }: FunctionOptions): Promise<FunctionReturn> {
    try {
        ...
        if (res2.data.alwaysCloseOnWithdraw === value) {
