 ...
 */
export async function increasePerpPositionByMultiplying({ account, asset, sizeMultiplier, vault, limitPrice }: Props, options: FunctionOptions): Promise<FunctionReturn> {
