export const guCoinAbi = [
        ...
        inputs: [
            {
                ...
                internalType: 'struct IGuCoin.InitParams',
                name: 'params',
                type: 'tuple',
            },
        ],
    ...
    { inputs: [], name: 'AmountExceeded', type: 'error' },
    { inputs: [], name: 'CannotMintTokens', type: 'error' },
    { inputs: [], name: 'CannotPerformUntilLP', type: 'error' },
    { inputs: [], name: 'CurveCannotBurnTokens', type: 'error' },
    {
        inputs: [
    ...
    { inputs: [], name: 'InvalidLiquidityPool', type: 'error' },
    ...
    { anonymous: false, inputs: [{ indexed: false, internalType: 'address', name: 'inspector', type: 'address' }], name: 'MsgInspectorSet', type: 'event' },
    {
        anonymous: false,
        inputs: [
    ...
    { inputs: [], name: 'CREATOR_FEE', outputs: [{ internalType: 'uint80', name: '', type: 'uint80' }], stateMutability: 'view', type: 'function' },
    ...
    { inputs: [], name: 'LIQUIDITY_MANAGER', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
    ...
    { inputs: [], name: 'PROTOCOL_FEE', outputs: [{ internalType: 'uint80', name: '', type: 'uint80' }], stateMutability: 'view', type: 'function' },
    { inputs: [], name: 'SEND', outputs: [{ internalType: 'uint16', name: '', type: 'uint16' }], stateMutability: 'view', type: 'function' },
    { inputs: [], name: 'SEND_AND_CALL', outputs: [{ internalType: 'uint16', name: '', type: 'uint16' }], stateMutability: 'view', type: 'function' },
    { inputs: [], name: 'TARGET_ETH', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
    { inputs: [], name: 'TVL', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
    { inputs: [], name: 'VIRTUAL_BALANCE', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
    ...
    { inputs: [], name: 'approvalRequired', outputs: [{ internalType: 'bool', name: '', type: 'bool' }], stateMutability: 'pure', type: 'function' },
    {
        inputs: [
            { internalType: 'address', name: 'spender', type: 'address' },
    ...
    { inputs: [], name: 'bondingCurve', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
    ...
    { inputs: [], name: 'isLPd', outputs: [{ internalType: 'bool', name: '', type: 'bool' }], stateMutability: 'view', type: 'function' },
    {
        inputs: [
            { internalType: 'uint32', name: '_eid', type: 'uint32' },
    ...
    { inputs: [], name: 'msgInspector', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
    ...
    { inputs: [], name: 'oApp', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
    {
        inputs: [],
        name: 'oAppVersion',
        outputs: [
    ...
    { inputs: [], name: 'preCrime', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
    ...
    { inputs: [{ internalType: 'address', name: '_msgInspector', type: 'address' }], name: 'setMsgInspector', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    {
        inputs: [
            { internalType: 'uint32', name: '_eid', type: 'uint32' },
            { internalType: 'bytes32', name: '_peer', type: 'bytes32' },
    ...
    { inputs: [{ internalType: 'address', name: '_preCrime', type: 'address' }], name: 'setPreCrime', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    { inputs: [], name: 'sharedDecimals', outputs: [{ internalType: 'uint8', name: '', type: 'uint8' }], stateMutability: 'pure', type: 'function' },
