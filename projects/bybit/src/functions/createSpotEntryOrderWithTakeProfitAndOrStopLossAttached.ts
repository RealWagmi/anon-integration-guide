...
export async function createSpotEntryOrderWithTakeProfitAndOrStopLossAttached(
    { market, side, amount, takeProfitPrice, stopLossPrice, limitPrice }: Props,
    ...
    try {
        ...
        // Create the order
        const order = await createSpotEntryOrderWithTakeProfitAndOrStopLossAttachedHelper(exchange, marketObject, side, amount, limitPrice, takeProfitPrice, stopLossPrice);
