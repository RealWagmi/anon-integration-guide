...
export async function withdrawSSR({ chainName, amount }: Props, options: FunctionOptions): Promise<FunctionReturn> {
	...
	return toResult(`Successfully withdrawn ${amount} USDS from SSR. ${withdrawMessage.message}`);
}
