...
/**
 * Withdraws maximum available WETH from the protocol.
 * @param props - The withdraw parameters.
 * @param tools - System tools for blockchain interactions.
 * @returns Transaction result.
 */
export async function maxWithdrawWETH(
  ...
  await notify("Preparing to withdraw all WETH...");
  ...
  return toResult(
    result.isMultisig
      ...
      : `Successfully withdrew maximum WETH. ${withdrawMessage.message}`
  );
}
