export default [{
    ...
    inputs: [{internalType: "uint160", name: "sqrtRatioAX96", type: "uint160"}, {
        internalType: "uint160",
        name: "sqrtRatioBX96",
        type: "uint160"
    ...
    outputs: [{
        "components": [{internalType: "int24", name: "tick", type: "int24"}, {
            internalType: "uint160",
            name: "sqrtRatioX96",
            type: "uint160"
            ...
            name: "liquidityGross",
            type: "uint128"
        }], internalType: "struct ISugarHelper.PopulatedTick[]", name: "populatedTicks", type: "tuple[]"
    }],
    stateMutability: "view",
    type: "function"
}, {
    ...
    outputs: [{internalType: "uint160", name: "sqrtRatioX96", type: "uint160"}],
    stateMutability: "pure",
    type: "function"
}, {
