export const bribeAbi = [
    ...
    { inputs: [], name: 'DURATION', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
    {
        inputs: [
            ...
            { internalType: 'address', name: '_vtr', type: 'address' },
            { internalType: 'address', name: '_onr', type: 'address' },
        ],
        name: '_deposit',
        outputs: [],
    ...
    { inputs: [], name: 'rewardsListLength', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
    {
        inputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    ...
    { inputs: [], name: 'supplyNumCheckpoints', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
    {
        inputs: [
