export default [
    ...
    },
    {
        anonymous: false,
        inputs: [
            { indexed: false, internalType: 'contract MultiRewardDistributor', name: 'oldRewardDistributor', type: 'address' },
            { indexed: false, internalType: 'contract MultiRewardDistributor', name: 'newRewardDistributor', type: 'address' },
        ],
    ...
    },
    {
        anonymous: false,
        inputs: [
            { indexed: false, internalType: 'address', name: 'oldSupplyCapGuardian', type: 'address' },
            { indexed: false, internalType: 'address', name: 'newSupplyCapGuardian', type: 'address' },
        ],
        name: 'NewSupplyCapGuardian',
        type: 'event',
    },
    { inputs: [{ internalType: 'contract Unitroller', name: 'unitroller', type: 'address' }], name: '_become', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    {
        inputs: [
    ...
    {
        inputs: [{ internalType: 'contract MultiRewardDistributor', name: 'newRewardDistributor', type: 'address' }],
    ...
    {
        inputs: [{ internalType: 'address', name: 'newSupplyCapGuardian', type: 'address' }],
    ...
    { inputs: [], name: 'borrowCapGuardian', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
    {
    ...
    { inputs: [{ internalType: 'address', name: 'holder', type: 'address' }], name: 'claimReward', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    { inputs: [], name: 'closeFactorMantissa', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
    { inputs: [], name: 'comptrollerImplementation', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
    {
    ...
    { inputs: [], name: 'getAllMarkets', outputs: [{ internalType: 'contract QiToken[]', name: '', type: 'address[]' }], stateMutability: 'view', type: 'function' },
    {
        inputs: [{ internalType: 'address', name: 'account', type: 'address' }],
        name: 'getAssetsIn',
        outputs: [{ internalType: 'contract QiToken[]', name: '', type: 'address[]' }],
    ...
    { inputs: [], name: 'isComptroller', outputs: [{ internalType: 'bool', name: '', type: 'bool' }], stateMutability: 'view', type: 'function' },
    {
        inputs: [{ internalType: 'contract QiToken', name: 'qiToken', type: 'address' }],
        name: 'isDeprecated',
        outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
    ...
    { inputs: [], name: 'pauseGuardian', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
    { inputs: [], name: 'pendingAdmin', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
    { inputs: [], name: 'pendingComptrollerImplementation', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
    {
        inputs: [
            { internalType: 'address', name: 'qiToken', type: 'address' },
    ...
    { inputs: [], name: 'rewardDistributor', outputs: [{ internalType: 'contract MultiRewardDistributor', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
    {
        inputs: [
            { internalType: 'address', name: 'qiTokenCollateral', type: 'address' },
            { internalType: 'address', name: 'qiTokenBorrowed', type: 'address' },
    ...
    { inputs: [], name: 'seizeGuardianPaused', outputs: [{ internalType: 'bool', name: '', type: 'bool' }], stateMutability: 'view', type: 'function' },
    { inputs: [], name: 'supplyCapGuardian', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
    {
        inputs: [{ internalType: 'address', name: '', type: 'address' }],
        name: 'supplyCaps',
        outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    ...
    { inputs: [], name: 'transferGuardianPaused', outputs: [{ internalType: 'bool', name: '', type: 'bool' }], stateMutability: 'view', type: 'function' },
] as const;
