    ...
    const messages: ConversationMessage[] = [
        {
            ...
            For example:
            - If asked "Show the withdrawal request with the highest amount":
              1. First call getOpenWithdrawRequests
              2. Then analyze the response to find the highest amount
            - If asked about token balances:
              1. First call the relevant balance tool
              2. Then provide the analysis
